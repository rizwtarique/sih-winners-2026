...
import { Hive, HoneyBatch, AlertItem, LearningTopic, FarmerProfile } from '../types';
...
export const INITIAL_HIVES: Hive[] = [
  ...
  },
  {
    ...
    healthAssessment: {
      ...
      status: 'healthy',
      overallScore: 92,
      predictionHeadline: 'Balanced homeostatic microclimate with strong hygienic nurse bee cluster',
      confidenceWord: 'High',
      confidencePct: 91,
      factors: [
        { name: 'Brood Temperature', value: '34.2°C (Optimal)', impact: 'positive' },
        { name: 'Relative Humidity', value: '56.5% (Ideal)', impact: 'positive' },
        { name: 'Acoustics', value: '40.8 dB baseline', impact: 'positive' },
      ],
      recommendedAction: 'Super box is 65% capped. Add second shallow super before weekend nectar surge.',
      lastUpdated: '8 mins ago',
      isModelEstimate: true,
    },
    yieldPrediction: {
      hiveId: 'hive-04',
      estimatedNextHarvestKg: 21.0,
      baselineHistoricalKg: 20.0,
      method: 'Multi-Factor Sensor Trend',
      confidenceWord: 'High',
      factorsNoted: ['Active queen laying in double deep', 'Zero mite drop observed in bottom tray'],
    },
  },
  {
    id: 'hive-05',
    hiveCode: 'HIVE-RAJ-04',
    apiaryName: 'KVIC Honey Mission Apiary #4',
    location: 'Bhilwara, Rajasthan',
    queenYear: 2024,
    boxType: 'Langstroth 10-Frame',
    ...
    healthAssessment: {
      ...
      status: 'critical',
      overallScore: 42,
      predictionHeadline: 'Severe Brood Chill & Colony Cluster Disruption (<30°C)',
      confidenceWord: 'High',
      confidencePct: 94,
      factors: [
        { name: 'Brood Core Temp', value: '29.8°C (-4.7°C hypothermia risk)', impact: 'critical' },
        { name: 'Colony Roar', value: '64.2 dB sharp distress frequency', impact: 'critical' },
        { name: 'Weight Loss', value: '-1.4 kg over 24 hours (Sudden forager loss)', impact: 'critical' },
      ],
      recommendedAction: 'URGENT: Verify windward entrance reducer, check for queen loss or pesticide drift.',
      lastUpdated: '1 min ago',
      isModelEstimate: true,
    },
    yieldPrediction: {
      hiveId: 'hive-05',
      estimatedNextHarvestKg: 8.5,
      baselineHistoricalKg: 18.0,
      method: 'Multi-Factor Sensor Trend',
      confidenceWord: 'Medium',
      factorsNoted: ['Worker attrition requires supplementary sugar syrup feeding', 'Brood comb loss risk'],
    },
  },
  {
    id: 'hive-06',
    hiveCode: 'HIVE-RAJ-05',
    apiaryName: 'KVIC Honey Mission Apiary #4',
    location: 'Bhilwara, Rajasthan',
    queenYear: 2026,
    boxType: 'Langstroth 8-Frame',
    colonyCount: 1,
    status: 'healthy',
    lastSync: '4 mins ago',
    coordinates: {
    ...
    gridPosition: {
      row: 3,
      col: 1,
      zone: 'Zone C - Flora Windbreak',
      plotCode: 'PL-C1',
      orientation: 'South (180°)',
      shadeCover: 'Canopy Cover',
    },
    currentReading: {
      id: 'sr-106',
      hiveId: 'hive-06',
    ...
    healthAssessment: {
      ...
      status: 'healthy',
      overallScore: 95,
      predictionHeadline: 'Young 2026 marked queen established with prolific circular brood pattern',
      confidenceWord: 'High',
      confidencePct: 96,
      factors: [
        { name: 'Core Temperature', value: '34.0°C (Exact equilibrium)', impact: 'positive' },
        { name: 'Comb Humidity', value: '59.1% (Safe curing)', impact: 'positive' },
      ],
      recommendedAction: 'Healthy colony expansion. Continue bi-weekly digital telemetry audit.',
      lastUpdated: '4 mins ago',
      isModelEstimate: true,
    },
    yieldPrediction: {
      hiveId: 'hive-06',
      estimatedNextHarvestKg: 19.0,
      baselineHistoricalKg: 17.5,
      method: 'Baseline Historical Average',
      confidenceWord: 'High',
      factorsNoted: ['Strong spring nuc conversion', 'Proximity to acacia windbreak corridor'],
    },
  },
  {
    id: 'hive-07',
    hiveCode: 'HIVE-RAJ-06',
    apiaryName: 'KVIC Honey Mission Apiary #4',
    location: 'Bhilwara, Rajasthan',
    queenYear: 2024,
    boxType: 'Langstroth 10-Frame',
    colonyCount: 1,
    status: 'offline',
    lastSync: '48 mins ago (Gateway Timeout)',
    coordinates: {
      lat: 25.3455,
      lng: 74.6369,
      elevationMeters: 422,
    ...
    healthAssessment: {
      ...
      status: 'offline',
      overallScore: 78,
      predictionHeadline: 'IoT Node Offline: LoRaWAN Telemetry ping lost for 48 minutes',
      confidenceWord: 'Low',
      confidencePct: 50,
      factors: [
        { name: 'Sensor Link', value: 'No telemetry packets received since 48m', impact: 'warning' },
        { name: 'Last Known Temp', value: '33.4°C (Normal at last contact)', impact: 'neutral' },
      ],
      recommendedAction: 'Check ESP32 battery level (LiPo 3.7V) and solar charging panel at Plot C-3.',
      lastUpdated: '48 mins ago',
      isModelEstimate: true,
    },
    yieldPrediction: {
      hiveId: 'hive-07',
      estimatedNextHarvestKg: 20.0,
      baselineHistoricalKg: 20.0,
      method: 'Baseline Historical Average',
      confidenceWord: 'Low',
      factorsNoted: ['Awaiting telemetry restoration to re-calculate weight delta'],
    },
  },
  {
    id: 'hive-03',
    ...
    gridPosition: {
      row: 1,
      col: 2,
      zone: 'Zone North - Sunflower Parcel',
      plotCode: 'PL-N1',
      orientation: 'East-South-East (110°)',
      shadeCover: 'Partial Shade',
    },
    currentReading: {
      id: 'sr-103',
  ...
  },
  {
    ...
    healthAssessment: {
      ...
      status: 'watch',
      overallScore: 71,
      predictionHeadline: 'High Relative Humidity (73.5%) - Fungal Condensation Risk',
      confidenceWord: 'Medium',
      confidencePct: 78,
      factors: [
        { name: 'Comb Humidity', value: '73.5% (Exceeds 65% safe envelope)', impact: 'warning' },
        { name: 'Brood Temp', value: '35.6°C (Upper acceptable limit)', impact: 'neutral' },
      ],
      recommendedAction: 'Tilt bottom board 2 degrees forward for moisture runoff and clear mesh floor.',
      lastUpdated: '6 mins ago',
      isModelEstimate: true,
    },
    yieldPrediction: {
      hiveId: 'hive-08',
      estimatedNextHarvestKg: 22.0,
      baselineHistoricalKg: 23.0,
      method: 'Multi-Factor Sensor Trend',
      confidenceWord: 'Medium',
      factorsNoted: ['Moisture reduction required to prevent premature honey fermentation'],
    },
  },
];
...
export const MOCK_FARMERS: FarmerProfile[] = [
  {
    ...
    kvicRegistrationNumber: 'KVIC/HM/RAJ/2023/8841',
    aadhaarKycVerified: true,
    bankAccountLinked: true,
    village: 'Mandal Village, Apiary Cluster #4',
    tehsil: 'Mandal',
    district: 'Bhilwara',
    state: 'Rajasthan',
    pincode: '311403',
    cooperativeName: 'Mewar Natural Honey Farmers Producer Co. Ltd. (FPO)',
    contactPhone: '+91 98290 41203',
    experienceYears: 14,
    totalActiveColonies: 38,
    beeSpecies: ['Apis mellifera (Italian Honey Bee)', 'Apis cerana indica (Indian Hive Bee)'],
    primaryFlora: ['Wild Mustard (Brassica campestris)', 'Desert Flora', 'Babul (Acacia nilotica)', 'Beri (Ziziphus mauritiana)'],
    certifications: [
      'KVIC Honey Mission Certified (Grade A+)',
      'Zero-Antibiotic Natural Apiary Practice',
      'Organic Non-GMO Forage Zone Accreditation',
      'FSSAI Beekeeper Registration #22223074000189',
    ],
    subsidyAwarded: '10 Langstroth Bee-Boxes, Stainless Steel Honey Extractor & Solar Smoker under KVIC Honey Mission',
    bio: 'Third-generation master beekeeper practicing non-destructive, cold-settling raw extraction in the arid and semi-arid flora zones of Bhilwara, Rajasthan. Member of the State Honey Board committee for migratory apiculture.',
    qrToken: 'kvic_farmer_8841_passport',
    qrUrl: 'https://honeychain.org/farmer/KVIC-FARMER-8841',
    registeredDate: '14 March 2023',
    hiveIds: ['hive-01', 'hive-02', 'hive-04', 'hive-05'],
  ...
  },
  {
    ...
    kvicRegistrationNumber: 'KVIC/HM/MAH/2024/9102',
    aadhaarKycVerified: true,
    bankAccountLinked: true,
    village: 'Panchavati Rural, Dindori Valley',
    tehsil: 'Dindori',
    district: 'Nashik',
    state: 'Maharashtra',
    pincode: '422202',
    cooperativeName: 'Sahyadri Agro-Beekeepers Cluster',
    contactPhone: '+91 94230 77124',
    experienceYears: 9,
    totalActiveColonies: 26,
    beeSpecies: ['Apis mellifera'],
    primaryFlora: ['Wild Acacia', 'Sunflower', 'Jamun (Black Plum)', 'Neem'],
    certifications: [
      'KVIC Honey Mission Certified',
      'NABL Tested Residue-Free',
      'FSSAI Registered',
    ],
    subsidyAwarded: '10 Bee-Boxes & Extraction Kit under PM KVIC Mission',
    bio: 'Specializes in multi-floral forest and orchard pollination honey along the Western Ghats foothills. Employs IoT weight and temperature sensors for precise swarm prevention and high-enzymatic extraction.',
    qrToken: 'kvic_farmer_9102_passport',
    qrUrl: 'https://honeychain.org/farmer/KVIC-FARMER-9102',
    registeredDate: '22 January 2024',
    hiveIds: ['hive-03', 'hive-06'],
    batchIds: ['batch-03'],
  },
  {
    id: 'KVIC-FARMER-7450',
    ...
    kvicRegistrationNumber: 'KVIC/HM/HP/2022/7450',
    aadhaarKycVerified: true,
    bankAccountLinked: true,
    village: 'Chamba High Valley',
    tehsil: 'Chamba',
    district: 'Kangra',
    state: 'Himachal Pradesh',
    pincode: '176001',
    cooperativeName: 'Himalayan Forest Flora Society',
    contactPhone: '+91 98160 55432',
    experienceYears: 18,
    totalActiveColonies: 45,
    beeSpecies: ['Apis cerana indica (Himalayan Bee)', 'Apis mellifera'],
    primaryFlora: ['Wild Himalayan Multiflora', 'Robinia (False Acacia)', 'Apple Blossom', 'Wild Plectranthus'],
    certifications: [
      'KVIC Honey Mission Master Trainer',
      'Himalayan Organic Certified',
      'FSSAI Certified Raw Honey Producer',
    ],
    subsidyAwarded: 'High-Altitude Insulation Bee-Boxes & Solar Refractometer',
    bio: 'Alpine apiculture specialist managing cold-climate migratory apiaries in Himachal Pradesh. Traditional stingless and Apis cerana conservation practitioner.',
    qrToken: 'kvic_farmer_7450_passport',
    qrUrl: 'https://honeychain.org/farmer/KVIC-FARMER-7450',
    registeredDate: '05 November 2022',
    hiveIds: ['hive-07', 'hive-08'],
...
export const INITIAL_ALERTS: AlertItem[] = [
  {
    ...
    message: 'Temperature reached 37.8°C with elevated acoustic harmonics (59.8 dB). Colony may be preparing to swarm or experiencing excessive ambient radiant heat.',
    hiveId: 'hive-02',
  ...
  },
  {
    ...
    type: 'sensor_anomaly',
    severity: 'critical',
    title: 'Severe Brood Chill in Hive-RAJ-04',
    message: 'Core temperature dropped to 29.8°C (-4.7°C hypothermia risk) with acoustic distress roar (64.2 dB) and -1.4 kg forager loss.',
    hiveId: 'hive-05',
    timestamp: '5 mins ago',
    isRead: false,
    recommendedAction: 'Immediate physical inspection: check entrance reducer, verify queen status and windward shelter.',
  },
  {
    id: 'alt-02',
    type: 'harvest_due',
  ...
  },
  {
    ...
    type: 'sensor_anomaly',
    severity: 'warning',
    title: 'LoRaWAN Telemetry Timeout in Hive-RAJ-06',
    message: 'No sensor packets received from Plot C-3 gateway node for 48 minutes. Node marked offline.',
    hiveId: 'hive-07',
    timestamp: '48 mins ago',
    isRead: false,
    recommendedAction: 'Inspect ESP32 solar charging panel and antenna lead at Plot C-3.',
  },
  {
    id: 'alt-06',
    type: 'sensor_anomaly',
    severity: 'warning',
    title: 'Elevated Moisture in Hive-NSH-08',
    message: 'Internal comb relative humidity at 73.5% exceeds 65% fungal risk threshold. Risk of chalkbrood and fermented nectar.',
    hiveId: 'hive-08',
    timestamp: '30 mins ago',
    isRead: false,
    recommendedAction: 'Tilt bottom board 2 degrees forward for condensation drainage.',
  },
  {
    id: 'alt-03',
